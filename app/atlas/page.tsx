...
export const metadata = {
  title: 'Map',
  description:
    'One map, two views: the chain from producer to technology, and the countries those rows sit in.',
};
          ...
          <>
            ...
            <figure className="atlas-overview">
              <figcaption>
                ...
                <p>
                  Bar length counts mapped bottlenecks; the sourced count is shown beside it. This
                  is a coverage chart, not a measurement of capacity or importance.
                </p>
              </figcaption>
            ...
            <p className="my-8 max-w-prose text-sm text-fg-secondary">
              The map groups records by research stage. It does not assert that every stage feeds
              the next, or that a listed producer supplies another company. Open a record to check
