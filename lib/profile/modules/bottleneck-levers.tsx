...
import { capitalHref, policyHref, scienceHref } from '../../links';
import { t } from '../../i18n/messages';
import type { ProfileModule } from '../types';
import { bottleneck } from './bottleneck';

/**
 * What governs a bottleneck and what would change it: the rules on it, the
 * science that could relieve it, the calls made about it and who could fund it.
 */
...
export { rules, removes, calls, funding };
